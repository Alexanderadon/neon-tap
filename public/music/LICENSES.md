...
| `tutorial.mp3` | Apparatus Overlord (the tutorial song) | vitalezzz | [OpenGameArt](https://opengameart.org/content/apparatus-overlord) | CC0 1.0 |
...
| `sfx/swipe-0.mp3` | Kenney — Interface Sounds / `drop_002.ogg` | deck card passes the centre — soft woody tap (round-robin 1/2) |
| `sfx/swipe-1.mp3` | Kenney — Interface Sounds / `drop_003.ogg` | deck card passes the centre — soft woody tap (round-robin 2/2) |
