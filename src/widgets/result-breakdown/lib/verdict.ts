...
export type VerdictKind = 'failed' | 'stars' | 'no-miss' | 'record' | 'all' | 'two' | 'one' | 'none';
 ...
 */
export function verdictOf(result: Pick<PlayResult, 'failed' | 'stars' | 'fullCombo'>, meta: Meta | null | undefined): Verdict {
