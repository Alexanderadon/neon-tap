/** Shared dictionary: every key that existed before the v3 redesign (unchanged). Screen packages add their own parts. */
export const common = {
  appTitle: 'NEON TAP',
  ...
  customIntro: 'Брось сюда MP3, OGG или WAV — карта нот сгенерируется автоматически. Файл не покидает твой браузер.',
  ...
  achievements: {
    ...
    hardest: { title: 'Пройди трек сложности {n}', desc: 'Без провала' },
