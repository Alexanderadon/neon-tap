...
- [ ] **iOS Safari, звук**: первое касание → звук слышен при боковом переключателе «без звука» (шаг 3 анлока); входящий звонок / Siri / сворачивание → возврат → первое касание возвращает звук; метроном калибровки слышен и ровный; SFX попаданий не «съедаются» при 8 нотах/с.
